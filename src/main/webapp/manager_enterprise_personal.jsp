    ...
    <div class="layui-row">
        <form class="layui-form" id="update" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="enterpriseName" autocomplete="off" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="contactName" autocomplete="off" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="contactTel" autocomplete="off" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="email" name="contactEmail" autocomplete="off" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="enterprisePass" autocomplete="off" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="enterpriseIntro" autocomplete="off" readonly
