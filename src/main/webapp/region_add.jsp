        ...
        <form id="addsite" class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select class="layui-input" name="provinceId" lay-verify="required" autocomplete="off">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="regionName" autocomplete="off" placeholder="填写城市名称"
...
<script>
    ...
    layui.use(['laydate', 'form', 'layer'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/system/addOrUpdateRegion",
