        ...
        <form id="addsite" class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="text" class="layui-input" lay-verify="required" value="${student.stuName}"
                           readonly="true">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="intentionMajor" autocomplete="off" placeholder="填写期望岗位"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="intentionSalary" autocomplete="off" placeholder="填写期望薪资"
                           class="layui-input" lay-verify="required">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="regionId" class="layui-input">
                        ...
                        <c:forEach items="${regions}" var="region">
                            <option value="${region.regionId}" class="layui-input">${region.regionName}</option>
                        </c:forEach>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="intentionOther" autocomplete="off" placeholder="填写掌握技能"
