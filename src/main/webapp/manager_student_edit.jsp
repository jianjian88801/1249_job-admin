    ...
    <div class="layui-row">
        <form class="layui-form" id="update" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select class="layui-input" name="departId" lay-verify="required" lay-filter="depart" autocomplete="off">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select class="layui-input" name="majorId" id="major" lay-verify="required" autocomplete="off">
                ...
                <div class="layui-input-block">
                    <select class="layui-input" name="politicalId" lay-verify="required" autocomplete="off">
                        ...
                        <c:forEach items="${politicalList}" var="political">
                            <option value="${political.politicalId}"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuGraduTime" autocomplete="off" id="sGrdate"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuPass" autocomplete="off" id="spwd"
