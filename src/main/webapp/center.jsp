    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <c:if test="${sessionScope.enterprise != null}">
                <a href="javascript:;">
                    <c:out value="${sessionScope.enterprise.enterpriseName}"/>
                </a>
            </c:if>
            ...
            <dl class="layui-nav-child">
                ...
                <dd>
                    ...
                    <c:if test="${sessionScope.enterprise != null}">
                        <a onclick="xadmin.open('个人信息','${pageContext.request.contextPath}/enterprise/selectById/${sessionScope.enterprise.enterpriseId}',550,600)">个人信息</a>
                    </c:if>
                    <c:if test="${sessionScope.student != null}">
        ...
        <ul id="nav">
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    <c:if test="${sessionScope.student!=null}">
                        <li>
                            <a onclick="xadmin.add_tab('招聘信息管理','hiring/findHire?enterpriseId=${sessionScope.enterprise.enterpriseId}&requireState=1',true)">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>招聘信息管理</cite></a>
                        </li>
                    </c:if>
                    <c:if test="${sessionScope.enterprise!=null}">
                        <li>
                            <a onclick="xadmin.add_tab('招聘信息管理','hiring/findHireById?enterpriseId=${sessionScope.enterprise.enterpriseId}',true)">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>招聘信息管理</cite></a>
                        </li>
                    </c:if>
                    <c:if test="${sessionScope.enterprise!=null}">
                        <li>
                            <a onclick="xadmin.add_tab('招聘信息列表','note/selectNoteAllById?enterpriseId=${sessionScope.enterprise.enterpriseId}',true)">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>招聘列表管理</cite></a>
                        </li>
                    </c:if>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('企业信息管理','enterprise/selectEnterpriseAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>企业信息管理</cite></a>
                    </li>
                    <c:if test="${sessionScope.enterprise != null}">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <c:if test="${sessionScope.enterprise != null}">
                        <li>
                            <a onclick="xadmin.add_tab('招聘信息管理','hiring/selectHiringAllbyeid',true)">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>招聘信息管理</cite></a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${sessionScope.enterprise != null}">
                        <li>
                            <a onclick="xadmin.add_tab('招聘记录管理','note/selectNoteAllbyeid',true)">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>招聘记录管理</cite></a>
                        </li>
                    </c:if>
                    <c:if test="${sessionScope.university != null}">
                        <li>
                            <a onclick="xadmin.add_tab('招聘记录管理','note/selectNoteAll',true)">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>招聘记录管理</cite></a>
                        </li>
                    </c:if>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('省份管理','province/selectProvinceAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>省份管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('城市管理','city/selectCityAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>城市管理</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('学校管理','university/selectUniversityAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>学校管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('院系管理','faculty/selectFacultyAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>院系管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('专业管理','major/selectMajorAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>专业管理</cite></a>
                    </li>
                </ul>
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('企业认证审核','enterprise/selectEnterpriseByFlag',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>企业认证审核</cite></a>
                    </li>
                    <%--<li>
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('学生就业信息审核','obtain/selectObtainAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    ...
                    <%--</li>--%>
                    <li>
                        <a onclick="xadmin.add_tab('招聘信息查看','hiring/selectHiringAll',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>招聘信息查看</cite></a>
                    </li>
                    <li>
