            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" method="post"
                          action="${pageContext.request.contextPath}/system/showAllHire">
                        <div class="layui-input-inline layui-show-xs-block">
                            <input type="text" name="requireJob" autocomplete="off" placeholder="请输入企业代码"
                                   class="layui-input"/>
                        </div>
                        <div class="layui-input-inline layui-show-xs-block">
                            <select name="requireState" disabled>
                    ...
                    <div align="center">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                <%--首页--%>
                                <li>
                                    <a href="${pageContext.request.contextPath}/system/showAllHire?enterpriseId=${enterpriseId}&requireState=${requireState}&offset=1&size=${pager.size}">首页</a>
                                </li>
                                <%--上一页--%>
                                ...
                                <c:if test="${pager.offset>1}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/system/showAllHire?enterpriseId=${enterpriseId}&requireState=${requireState}&offset=${pager.offset-1}&size=${pager.size}">&laquo;</a>
                                    </li>
                                </c:if>
                                <%--分页按钮--%>
                                <c:forEach begin="${begin}" end="${end}" var="i">
                                    <c:if test="${pager.offset==i}">
                                        <li class="active">
                                            <a href="${pageContext.request.contextPath}/system/showAllHire?enterpriseId=${enterpriseId}&requireState=${requireState}&offset=${i}&size=${pager.size}">${i}</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${pager.offset!=i}">
                                        <li>
                                ...
                                <c:if test="${pager.offset<pager.totalPage}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/system/showAllHire?enterpriseId=${enterpriseId}&requireState=${requireState}&offset=${pager.offset+1}&size=${pager.size}">&raquo;</a>
                                    </li>
                                </c:if>
                                <%--尾页--%>
                                <li>
                                    <a href="${pageContext.request.contextPath}/system/showAllHire?enterpriseId=${enterpriseId}&requireState=${requireState}&offset=${pager.totalPage}&size=${pager.size}">尾页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
