...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" id="update" method="post">
            ...
            <input type="hidden" name="provinceId" value="${region.provinceId}">
            <div class="layui-form-item">
                <label class="layui-form-label">
                    <span class='x-red'>*</span>省名称
                </label>
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" id="cname" readonly
                           class="layui-input" lay-verify="required" value="${region.province.provinceName}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
                ...
                <div class="layui-input-block">
                    <input type="text" name="regionName" autocomplete="off" id="cname"
                           class="layui-input" lay-verify="required" value="${region.regionName}">
                </div>
            </div>
