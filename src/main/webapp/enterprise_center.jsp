...
<div class="left-nav show_list" id="table1">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:;" onclick="xadmin.add_tab('我的桌面','ent_welcome.jsp')">
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('简历信息管理','enterprise/showAllResume?intentionState=1&offset=1&size=5',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>简历信息管理</cite>
                        </a>
                    </li>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='ent_welcome.jsp' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
