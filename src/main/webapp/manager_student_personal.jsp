    ...
    <div class="layui-row">
        <form class="layui-form" id="update" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuCredit" autocomplete="off" id="sidcard" readonly="readonly"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuEntrance" autocomplete="off" id="sEndate" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuGraduTime" autocomplete="off" id="sGrdate" readonly
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuContr" autocomplete="off" id="sphone" readonly="readonly"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select class="layui-input" name="stateId" lay-verify="required" autocomplete="off" disabled>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuPass" autocomplete="off" id="spwd" readonly="readonly"
